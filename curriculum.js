    ...
    units: [
      ...
      /* ---------------------------------------------------------------- */
      {
        ...
        card: {
          ...
          howto: '동사 앞에 <b>should</b>를 넣으면 "~하는 게 좋다"예요. 더 센 충고("안 그러면 큰일 나")는 <b>had better</b>를 써요. 둘 다 <b>뒤 동사는 원형 그대로</b>예요. 울타리 — <b>어른·선생님께는 had better를 쓰지 않아요.</b> 협박처럼 들리거든요. 그럴 땐 <b>should</b>가 안전해요.',
          demo: {
            ko: ['너는', '좀 쉬는', '게 좋겠다'],
            steps: [
              { q: '누가?',       ko: '너는',       en: 'You' },
  ...
  },
  {
    ...
    units: [
      /* ---------------------------------------------------------------- */
      {
        id: 'L12-1',
        title: '조건절 vs 가정법 과거',
        tagline: '가정 — 열린 문이면 will, 닫힌 문이면 would',
        skeleton: 'If + 현재, will ~ (열림)  /  If + 과거, would ~ (닫힘)',
        focus: '가정법 과거',
        card: {
          achieve: '이걸 익히면 <b>"~하면 ~할 거야"</b>(일어날 수 있는 일)와 <b>"~라면 ~할 텐데"</b>(현실이 아닌 상상)를 구분해 말할 수 있어요.',
          howto: '한국어 신호 — <b>"~하면 ~할 거야"</b>는 열린 문: <b>If + 현재, will + 동사원형</b> (If it rains, I will stay home). <b>"~라면 ~할 텐데"</b>는 닫힌 문(현실 반대): <b>If + 과거, would + 동사원형</b>. 핵심 감각 — 여기서 과거형은 과거가 아니라 <b>현실에서 한 칸 물러선 거리감</b>이에요. L9에서 공손함을 만들던 그 물러서기가, 여기선 비현실을 만들어요. 만들기 — 가정법의 be동사는 주어와 상관없이 <b>무조건 were</b> (If I were you). 울타리 — <b>if절 안에 will ❌</b> (If it will rain ❌), 가정법에 <b>If I was</b>보다 <b>If I were</b>가 정확해요.',
          demo: {
            ko: ['내가 너라면,', '그 기회를', '잡을 텐데'],
            steps: [
              { q: '열림? 닫힘?',  ko: '내가 너일 수는 없음 → 닫힌 문',   en: '(가정법 과거)' },
              { q: '만약?',       ko: 'be동사는 무조건 were!',          en: 'If I were you,' },
              { q: '~할 텐데?',    ko: 'would + 동사원형',              en: 'I would take the chance' },
            ],
            answer: 'If I were you, I would take the chance.',
            tip: '과거형은 과거가 아니라 "현실에서 한 칸 떨어졌다"는 신호예요.',
          },
        },
        practice: [
          { ko: '내일 비가 오면, 나는 집에 있을 거야',
            steps: [{ q:'열림? 닫힘?', en:'(열림 → 현재 + will)', hint:'내일 비는 올 수도 있음 — 열린 문' }, { q:'만약?', en:'If it rains tomorrow,', hint:'if절엔 will ❌ — 현재형으로!' }, { q:'~할 거야?', en:'I will stay home' }],
            answer: 'If it rains tomorrow, I will stay home.' },
          { ko: '내가 새라면, 너에게 날아갈 텐데',
            steps: [{ q:'열림? 닫힘?', en:'(닫힘 → 과거 + would)', hint:'내가 새일 수는 없음 — 닫힌 문' }, { q:'만약?', en:'If I were a bird,', hint:'be동사는 무조건 were' }, { q:'~할 텐데?', en:'I would fly to you' }],
            answer: 'If I were a bird, I would fly to you.' },
          { ko: '그가 여기 있다면, 그는 우리를 도와줄 텐데',
            steps: [{ q:'열림? 닫힘?', en:'(닫힘)', hint:'지금 없음 — 현실 반대' }, { q:'만약?', en:'If he were here,', hint:'he라도 were!' }, { q:'~할 텐데?', en:'he would help us' }],
            answer: 'If he were here, he would help us.' },
        ],
        challenges: [
          { ko:'내가 복권에 당첨된다면, 나는 세계를 여행할 텐데.', answer:'If I won the lottery, I would travel the world.',
            chunks:[{ lab:'문', ko:'거의 불가능 → 닫힌 문' }, { lab:'만약', ko:'If + 과거 (won)' }, { lab:'~할 텐데', ko:'would + 동사원형' }] },
          { ko:'네가 서두르면, 너는 그 기차를 탈 거야.', answer:'If you hurry, you will catch the train.' },
          { ko:'내가 그의 전화번호를 안다면, 그에게 전화할 텐데.', answer:'If I knew his phone number, I would call him.' },
          { ko:'시간이 더 있다면, 나는 중국어를 배울 텐데.', answer:'If I had more time, I would learn Chinese.' },
          { ko:'네가 지금 출발하면, 늦지 않을 거야.', answer:'If you leave now, you will not be late.' },
        ],
        similar: [
          { ko:'내가 부자라면, 그 차를 살 텐데.', answer:'If I were rich, I would buy the car.' },
          { ko:'날씨가 좋으면, 우리는 소풍을 갈 거야.', answer:'If the weather is nice, we will go on a picnic.' },
        ],
      },
      ...
      {
        id: 'L12-2',
        title: '가정법 과거완료 · 혼합 (되감기)',
        tagline: '가정 — 지나간 일을 되감을 땐 한 칸 더 물러서요',
        skeleton: 'If + had p.p., would have p.p.  /  혼합: If + had p.p., would + 원형 (now)',
        focus: '가정법 과거완료',
        card: {
          achieve: '이걸 익히면 <b>"~했더라면 ~했을 텐데"</b>로 지나간 일을 되감아 말할 수 있어요. 후회를 문장 전체로 펼치는 거예요.',
          howto: '한국어 신호 — <b>"~했더라면 ~했을 텐데"</b>. 만들기 — if절은 <b>had p.p.</b>, 주절은 <b>would/could/might have p.p.</b> L9-3의 후회(should have p.p.), L9-4의 추측(must have p.p.)과 <b>같은 have p.p. 가족</b>이에요 — 앞이 달라질 뿐. 혼합 가정법 — 조건은 과거인데 결과가 지금이면: <b>If + had p.p., would + 동사원형 (+ now)</b> (어제 안 자서 → 지금 피곤). 울타리 — if절에 <b>would ❌</b> (If I would have ❌), 되감기 앞뒤 짝을 흘리지 마세요 — 앞이 had p.p.면 뒤엔 have p.p.가 (지금 얘기가 아닌 한) 따라와요.',
          demo: {
            ko: ['내가 더 열심히 공부했더라면,', '시험에', '합격했을 텐데'],
            steps: [
              { q: '되감기?',     ko: '이미 지나간 일 — 한 칸 더 물러서기',  en: '(가정법 과거완료)' },
              { q: '만약?',       ko: 'had + p.p.',                      en: 'If I had studied harder,' },
              { q: '~했을 텐데?',  ko: 'would have + p.p.',               en: 'I would have passed the exam' },
            ],
            answer: 'If I had studied harder, I would have passed the exam.',
            tip: 'L9-3 should have p.p.(후회)의 사촌이에요. 되감기는 언제나 have p.p.',
          },
        },
        practice: [
          { ko: '네가 나에게 말했더라면, 내가 너를 도와줬을 텐데',
            steps: [{ q:'만약?', en:'If you had told me,', hint:'되감기 → had p.p.' }, { q:'~했을 텐데?', en:'I would have helped you', hint:'주절은 would have p.p.' }],
            answer: 'If you had told me, I would have helped you.' },
          { ko: '우리가 더 일찍 떠났더라면, 그 버스를 놓치지 않았을 텐데',
            steps: [{ q:'만약?', en:'If we had left earlier,' }, { q:'안 했을 텐데?', en:'we would not have missed the bus', hint:'부정은 would not have p.p.' }],
            answer: 'If we had left earlier, we would not have missed the bus.' },
          { ko: '내가 어젯밤에 잤더라면, 지금 피곤하지 않을 텐데',
            steps: [{ q:'만약?', en:'If I had slept last night,', hint:'조건은 과거 → had p.p.' }, { q:'지금은?', en:'I would not be tired now', hint:'결과가 지금! → would + 동사원형 (혼합)' }],
            answer: 'If I had slept last night, I would not be tired now.' },
        ],
        challenges: [
          { ko:'내가 그 사실을 알았더라면, 나는 거기에 가지 않았을 텐데.', answer:'If I had known the truth, I would not have gone there.',
            chunks:[{ lab:'만약', ko:'알았더라면 → had known' }, { lab:'되감기 짝', ko:'주절도 have p.p.' }, { lab:'부정', ko:'would not have gone' }] },
          { ko:'그가 조금만 더 조심했더라면, 그 사고는 일어나지 않았을 텐데.', answer:'If he had been more careful, the accident would not have happened.' },
          { ko:'네가 아침을 먹었더라면, 지금 배고프지 않을 텐데.', answer:'If you had eaten breakfast, you would not be hungry now.' },
          { ko:'내가 우산을 가져왔더라면, 젖지 않았을 텐데.', answer:'If I had brought an umbrella, I would not have gotten wet.' },
          { ko:'그녀가 그 회사에 지원했더라면, 합격했을지도 몰라.', answer:'If she had applied to the company, she might have passed.' },
        ],
        similar: [
          { ko:'내가 일찍 일어났더라면, 지각하지 않았을 텐데.', answer:'If I had gotten up early, I would not have been late.' },
          { ko:'우리가 그때 만났더라면, 지금 친구일 텐데.', answer:'If we had met then, we would be friends now.' },
        ],
      },
      ...
      {
        id: 'L12-3',
        title: 'I wish · as if (바람과 가정)',
        tagline: '가정 — if절 없이도 한 칸 물러설 수 있어요',
        skeleton: 'I wish + 과거/had p.p.  /  as if + 과거/had p.p.',
        focus: 'I wish · as if',
        card: {
          achieve: '이걸 익히면 <b>"~면 좋을 텐데"</b>(바람)와 <b>"마치 ~인 것처럼"</b>(사실 아님)을 말할 수 있어요. if 없이 쓰는 가정법이에요.',
          howto: '틀 두 개예요. ① <b>I wish + 과거</b> = "지금 ~면 좋을 텐데"(현실 반대), <b>I wish + had p.p.</b> = "그때 ~했더라면 좋았을 텐데"(과거 아쉬움). ② <b>as if + 과거</b> = "마치 ~인 것처럼"(실제 아님), <b>as if + had p.p.</b> = "마치 ~했던 것처럼". wish와 as if 뒤는 <b>자동으로 한 칸 물러선 시제</b>가 와요 — L12-1과 같은 거리두기예요. 울타리 — <b>I wish I am ❌ → were</b>. 그리고 <b>이루어질 수 있는 바람은 I hope + 현재</b>예요 (I hope you pass — 진짜 가능). 불가능하거나 현실과 반대일 때만 wish.',
          demo: {
            ko: ['내 키가', '더 크면', '좋을 텐데'],
            steps: [
              { q: '가능한가?',   ko: '지금 당장은 불가능 → wish',       en: 'I wish' },
              { q: '한 칸 뒤로?', ko: 'be동사는 were',                  en: 'I were' },
              { q: '무엇이?',     ko: '더 큰 — L10 비교급!',            en: 'taller' },
            ],
            answer: 'I wish I were taller.',
            tip: 'wish 뒤는 자동으로 한 칸 과거. 지금 얘기라도 과거형!',
          },
        },
        practice: [
          { ko: '오늘이 금요일이면 좋을 텐데',
            steps: [{ q:'바람?', en:'I wish', hint:'현실 반대 → wish' }, { q:'한 칸 뒤로?', en:'it were Friday', hint:'is ❌ → were' }],
            answer: 'I wish it were Friday.' },
          { ko: '내가 그때 사진을 찍었더라면 좋았을 텐데',
            steps: [{ q:'바람?', en:'I wish' }, { q:'과거 아쉬움?', en:'I had taken a picture then', hint:'지나간 일 → had p.p.' }],
            answer: 'I wish I had taken a picture then.' },
          { ko: '그는 마치 모든 것을 아는 것처럼 말한다',
            steps: [{ q:'뼈대는?', en:'He talks' }, { q:'마치?', en:'as if he knew everything', hint:'실제로는 모름 → 과거형 knew' }],
            answer: 'He talks as if he knew everything.' },
        ],
        challenges: [
          { ko:'나에게 형이 있으면 좋을 텐데.', answer:'I wish I had a brother.',
            chunks:[{ lab:'바람', ko:'현실 반대 → I wish' }, { lab:'한 칸 뒤로', ko:'have ❌ → had' }, { lab:'무엇이', ko:'형이' }] },
          { ko:'내가 어제 그 말을 하지 않았더라면 좋았을 텐데.', answer:'I wish I had not said that yesterday.' },
          { ko:'그녀는 마치 스타인 것처럼 행동한다.', answer:'She acts as if she were a star.' },
          { ko:'그는 마치 그 영화를 본 것처럼 말했다.', answer:'He talked as if he had seen the movie.' },
          { ko:'네가 여기 있으면 좋을 텐데.', answer:'I wish you were here.' },
        ],
        similar: [
          { ko:'내가 운전할 수 있으면 좋을 텐데.', answer:'I wish I could drive.' },
          { ko:'그녀는 마치 아무 일도 없었던 것처럼 웃었다.', answer:'She smiled as if nothing had happened.' },
        ],
      },
      ...
      /* ---------------------------------------------------------------- */
      {
        id: 'L12-4',
        title: '도치 · 분열문으로 강조하기',
        tagline: '재구성 — 어순을 흔들면 스포트라이트가 생겨요',
        skeleton: 'Never + 조동사 + S  /  Had I p.p., ~  /  It is [강조] that ~  /  What I ~ is …',
        focus: '문장 재구성',
        card: {
          achieve: '이걸 익히면 같은 문장을 <b>어순을 재구성해서</b> 원하는 곳에 스포트라이트를 비출 수 있어요. 만렙다운 스타일이에요.',
          howto: '네 가지 재구성 틀이에요. ① <b>부정어 도치</b> — Never 같은 부정어를 문두로 보내면 <b>조동사 + 주어</b>로 뒤집혀요: <b>Never have I seen ~</b>(그런 건 본 적이 없다니까!). ② <b>if 생략 도치</b> — If I had known → <b>Had I known</b>, ~ (L12-2의 세련된 옷). ③ <b>It ~ that 분열문</b> — 강조할 말을 It is/was와 that 사이에 넣고 <b>나머지는 전부 that절로</b>: It was you that called me(전화한 건 다름 아닌 너). ④ <b>What 분열문</b> — <b>What I need is ~</b>(내가 필요한 건 ~다). 울타리 — 부정어 도치에서 주어·동사를 안 뒤집으면 ❌ (Never I have seen ❌).',
          demo: {
            ko: ['나에게 전화한 건', '다름 아닌', '너였다'],
            steps: [
              { q: '스포트라이트?', ko: '너 — 강조할 말',                 en: 'you' },
              { q: '틀은?',        ko: 'It was ~ that 사이에 넣기',      en: 'It was you that' },
              { q: '나머지는?',     ko: '전부 that절로',                  en: 'called me' },
            ],
            answer: 'It was you that called me.',
            tip: '강조하고 싶은 말을 It과 that 사이에. 나머지는 that 뒤로.',
          },
        },
        practice: [
          { ko: '나는 그런 풍경을 한 번도 본 적이 없다 (강조)',
            steps: [{ q:'강조?', en:'Never', hint:'부정어를 문두로!' }, { q:'뒤집기?', en:'have I seen', hint:'조동사+주어 도치 — L5 현재완료가 뒤집힌 것' }, { q:'무엇을?', en:'such a view' }],
            answer: 'Never have I seen such a view.' },
          { ko: '내가 알았더라면, 너를 도와줬을 텐데 (if 없이)',
            steps: [{ q:'if 지우면?', en:'Had I known,', hint:'If I had known → if 빼고 Had가 앞으로' }, { q:'~했을 텐데?', en:'I would have helped you', hint:'주절은 L12-2 그대로' }],
            answer: 'Had I known, I would have helped you.' },
          { ko: '내가 필요한 것은 휴식이다',
            steps: [{ q:'틀은?', en:'What I need', hint:'"내가 필요한 것" 덩어리 — 통째로 주어' }, { q:'~이다?', en:'is some rest' }],
            answer: 'What I need is some rest.' },
        ],
        challenges: [
          { ko:'그 창문을 깬 것은 바로 톰이었다.', answer:'It was Tom that broke the window.',
            chunks:[{ lab:'스포트라이트', ko:'톰 → It was Tom' }, { lab:'틀', ko:'that' }, { lab:'나머지', ko:'창문을 깼다 — that절로' }] },
          { ko:'나는 그렇게 맛있는 파스타를 한 번도 먹어 본 적이 없다.', answer:'Never have I eaten such delicious pasta.' },
          { ko:'네가 어제 잃어버린 것은 바로 이 열쇠였다.', answer:'It was this key that you lost yesterday.' },
          { ko:'내가 원하는 것은 진실이다.', answer:'What I want is the truth.' },
          { ko:'네 모든 꿈이 이루어지길!', answer:'May all your dreams come true.' },
        ],
        similar: [
          { ko:'내가 그녀를 처음 만난 것은 바로 지난여름이었다.', answer:'It was last summer that I first met her.' },
          { ko:'나는 그렇게 감동적인 영화를 본 적이 없다.', answer:'Never have I seen such a touching movie.' },
        ],
      },
      ...
      {
        id: 'L12-5',
        title: '골라 쓰기 — 밋밋한 문장 다듬기',
        tagline: '골라 쓰기 — 만렙의 마지막 훈련이에요',
        skeleton: '상황(괄호) → 12레벨의 도구 중 하나',
        focus: '문장 다듬기',
        card: {
          achieve: '마지막 유닛이에요. 이제 <b>12레벨에서 배운 모든 도구</b>를 상황에 맞게 꺼내 쓸 수 있어요. 문장을 만드는 걸 넘어, 고르는 단계입니다.',
          howto: '여기서도 <b>틀린 문장을 고치는 게 아니에요.</b> 괄호 안 상황이 어떤 도구를 꺼낼지 알려줘요. <b>이룰 수 없는 바람</b> → I wish / 가정법 · <b>지나간 후회·되감기</b> → should have p.p. / If + had p.p. · <b>스포트라이트</b> → It ~ that / Never 도치 · <b>마음과 말투</b> → L9의 조동사, 부드러운 not as ~ as. 울타리 — 다듬기는 <b>화려하게가 아니라, 말하려는 마음에 맞게</b>예요. 도구를 쌓지 말고 <b>하나만</b> 고르세요.',
          demo: {
            ko: ['같은 사실도', '담는 마음에 따라', '문장이 달라져요'],
            steps: [
              { q: '밋밋하게',    ko: '나는 공부 안 했다. 떨어졌다',        en: 'I did not study. I failed.' },
              { q: '후회를 담아',  ko: '더 공부했어야 했는데 (L9)',          en: 'I should have studied harder.' },
              { q: '되감아서',    ko: '공부했더라면 붙었을 텐데 (L12)',      en: 'If I had studied, I would have passed.' },
            ],
            answer: '사실은 같아요. 어떤 마음을 담느냐가 문장을 정합니다.',
            tip: '괄호 안 상황을 먼저 읽으세요. 12레벨의 어느 도구인지 보여요.',
          },
        },
        practice: [
          { ko: '(이룰 수 없는 바람을 담아) 내가 지금 제주에 있으면 좋을 텐데',
            steps: [{ q:'도구는?', en:'I wish', hint:'불가능한 지금 → I wish + 과거' }, { q:'한 칸 뒤로?', en:'I were in Jeju', hint:'am ❌ → were' }, { q:'언제?', en:'now' }],
            answer: 'I wish I were in Jeju now.' },
          { ko: '(범인을 콕 집어 강조하며) 그 케이크를 먹은 것은 바로 내 동생이었다',
            steps: [{ q:'도구는?', en:'It was ~ that', hint:'스포트라이트 → 분열문' }, { q:'누구?', en:'my brother' }, { q:'나머지는?', en:'ate the cake' }],
            answer: 'It was my brother that ate the cake.' },
          { ko: '(지나간 선택을 되감으며) 내가 그 콘서트에 갔더라면, 그녀를 만났을 텐데',
            steps: [{ q:'도구는?', en:'If + had p.p.', hint:'되감기 → 가정법 과거완료' }, { q:'만약?', en:'If I had gone to the concert,' }, { q:'~했을 텐데?', en:'I would have met her' }],
            answer: 'If I had gone to the concert, I would have met her.' },
        ],
        challenges: [
          { ko:'(한 번도 없었음을 강조하며) 나는 이렇게 아름다운 밤하늘을 본 적이 없다.', answer:'Never have I seen such a beautiful night sky.',
            chunks:[{ lab:'상황', ko:'한 번도 없음 강조 → Never 도치' }, { lab:'뒤집기', ko:'have I seen' }, { lab:'무엇을', ko:'이렇게 아름다운 밤하늘' }] },
          { ko:'(마치 사실인 것처럼) 그는 마치 거기 있었던 것처럼 이야기한다.', answer:'He talks as if he had been there.' },
          { ko:'(진짜 필요한 것 하나를 강조하며) 내가 필요한 것은 약간의 잠이다.', answer:'What I need is some sleep.' },
          { ko:'(처음 보는 분께 정중하게 제안) 창문을 열어 드릴까요?', answer:'Would you like me to open the window?' },
          { ko:'(되돌릴 수 없는 과거를 아쉬워하며) 내가 너의 말을 들었더라면, 지금 곤란하지 않을 텐데.', answer:'If I had listened to you, I would not be in trouble now.' },
        ],
        similar: [
          { ko:'(바람을 담아) 내가 피아노를 칠 수 있으면 좋을 텐데.', answer:'I wish I could play the piano.' },
          { ko:'(강조하며) 나를 웃게 만든 것은 바로 그 한마디였다.', answer:'It was that one word that made me smile.' },
        ],
      },
    ],
    exam: { passScore: RULES.EXAM_PASS, total: RULES.EXAM_TOTAL, questions: [] },  // AI가 매번 새로 출제
