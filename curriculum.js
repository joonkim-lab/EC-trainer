...
const CURRICULUM = [
  ...
  },
  {
    ...
    units: [
      { id: 'L11-1', title: '관계대명사 주격 · 목적격', focus: '관계대명사' },
      { id: 'L11-2', title: '소유격 whose · that만 쓰는 자리', focus: '관계대명사 심화' },
      { id: 'L11-3', title: '계속적 용법 · 문장 전체를 받는 which', focus: '계속적 용법' },
      { id: 'L11-4', title: '복합관계사 (whoever · whatever …)', focus: '복합관계사' },
      { id: 'L11-5', title: '분사구문 (~하면서 · ~한 채)', focus: '분사구문' },
    ],
    exam: { passScore: RULES.EXAM_PASS, total: RULES.EXAM_TOTAL, questions: [] },  // AI가 매번 새로 출제
  },
  {
